        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row gap-4 mb-8 items-center justify-between">
                ...
                <div class="relative w-full md:w-96">
                    ...
                    <input type="text" placeholder="Search orders..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>

                {{-- NEW: Visit Store Button --}}
                <a href="{{ route('store.list') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 w-full md:w-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($orders as $order)
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow duration-300">
                        <div class="p-5 border-b border-gray-50 dark:border-gray-700/50 flex justify-between items-start">
                ...
                @empty
                    <div class="col-span-full py-20 text-center bg-white dark:bg-gray-800 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700">
                        <div class="text-gray-400 mb-2">No active orders found</div>
                        <a href="{{ route('store.list') }}" class="text-indigo-600 font-bold hover:underline">Browse the catalog</a>
                    </div>
                @endforelse
            </div>
