...
<div class="min-h-screen bg-slate-50">
    <div class="mx-auto max-w-3xl px-4 py-10">
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-slate-600">Remplis les informations ci-dessous pour créer un nouveau produit.</p>
        </div>
            ...
            <form action="{{ route('products.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <label class="flex cursor-pointer items-center gap-3 rounded-xl border border-slate-200 bg-white p-3 shadow-sm
